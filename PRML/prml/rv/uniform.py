...
class Uniform(RandomVariable):
    """
    Uniform distribution 均匀分布什么时候变成这样了， 这个公式写对了吗？是所有的均匀分布乘起来了吗
    p(x|a, b)
    ...
    def _pdf(self, X):
        ...
        return self.value * np.logical_and(higher, lower) # Compute the truth value of x1 AND x2 element-wise.
